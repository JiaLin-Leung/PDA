...
public class SpUtils {
    ...
    public SpUtils(Context context) {
        sp =   context.getSharedPreferences("pda",Context.MODE_PRIVATE);
        mEditor = sp.edit();
    }
    ...
    public static SharedPreferences get(Context context){
        if (sp==null){
            return context.getSharedPreferences("pda", Context.MODE_PRIVATE);
        }
        return sp;
    }
    /**
    ...
    public static void clear(Context context) {
        SharedPreferences sp = context.getSharedPreferences("pda",
